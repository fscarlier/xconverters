...
import os
from xconverters.sad_utils.sad_templates.sad_templates import SadTemplates
...
def from_sad_to_madx(sad_lattice, momentum, particle_type='electron'):
    ...
    madx = cpymad_lattice_conversion.from_madx_seqfile(temp_mad_path_seq, 'ring', momentum/1e9)
