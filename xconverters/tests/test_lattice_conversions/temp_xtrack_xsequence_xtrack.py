...
def example_cpymad_xsequence_cpymad():
    # Create xsequence lattice from madx lattice.seq
    ...
    # Create Xtrack Line
    xt_line = convert_lattices.to_xtrack(xsequence_lattice)

    # Create again Xsequence Lattice from Xtrack
    xsequence_lattice_new = convert_lattices.from_xtrack(xt_line)
