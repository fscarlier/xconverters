"""
Setup file for xconverters Package
------------------
xconverters: Package to manage particle accelerator lattices and interface to different simulation codes
"""
...
ABOUT_XCONVERTERS = about_package(ABOUT_FILE)
...
DEPENDENCIES = [
    ...
    "xsequence @ git+ssh://git@github.com/fscarlier/xsequence@nodes#egg=xsequence",
    "lark",
    "rich",
    ]
...
setuptools.setup(
    name=ABOUT_XCONVERTERS["__title__"],
    version=ABOUT_XCONVERTERS["__version__"],
    description=ABOUT_XCONVERTERS["__description__"],
    long_description=long_description,
    long_description_content_type="text/markdown",
    author=ABOUT_XCONVERTERS["__author__"],
    author_email=ABOUT_XCONVERTERS["__author_email__"],
    url=ABOUT_XCONVERTERS["__url__"],
    packages=setuptools.find_packages(include=(MODULE_NAME,)),
    include_package_data=True,
    python_requires=">=3.6",
    license=ABOUT_XCONVERTERS["__license__"],
    classifiers=[
